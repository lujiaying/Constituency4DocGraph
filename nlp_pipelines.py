...
Author: Jiaying Lu (jiaying.lu@emory.edu)
...
def produce_phrase_graphs_per_doc(doc_dict: dict, window_size: int) -> nx.Graph:
    ...
    # print('after coref resolve:', coref_mapping)
    # Add nodes
    offset = 0
...
if __name__ == '__main__':
    ...
    # COVID-IR Collaborate
    COVIDIR_subset_path = 'train.jsonlines'
    COVIDIR_subset_out_path = 'train.win5.pickle.gz'
    # produce_phrase_graphs_corpus(COVIDIR_subset_path, COVIDIR_subset_out_path, window_size=5)
